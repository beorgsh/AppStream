...
import { fetchPopularTV, getImageUrl } from "../Services/TmdbApi";
...
export default function TV() {
  const {
    ...
    loaderRef,
    hasMore,
  } = useInfiniteScroll(fetchPopularTV, "tv");
  ...
  return (
    <div className="p-4 mt-15">
      ...
      >
        {tvShows.map((show) => (
          <Link key={show.id} to={`/watch/tv/${show.id}`}>
            <motion.div
                ...
                <div className="block w-full">
                  ...
                  <div className="flex items-center text-yellow-400 justify-between w-full">
                    ...
                    <div className="flex justify-end">
                      <span className="text-sm text-gray-300"> TV Show</span>
                    </div>
                  </div>
                </div>
              </div>
